 ...
 *
 * Modified by lviripaeff to allow addition of a title graphic
 *******************************************************************************/
...
public class LoaderTitleAreaDialog extends Dialog {
     ...
     */
    public static final String DLG_IMG_TITLE_BANNER = "";//$NON-NLS-1$//dialog_title_banner_image


    private static final int H_GAP_IMAGE = 5;
    //Minimum dialog width (in dialog units)
    private static final int MIN_DIALOG_WIDTH = 50;//350
    //Minimum dialog height (in dialog units)
    private static final int MIN_DIALOG_HEIGHT = 50;
